...
def doOneIter(device, useset, model_t, optim_t, train_t, valid_t, resizeflag, usedcolumn, takenum, position):
...
if __name__ == "__main__":
    ...
    doOneIter(usedevice, setname, modeltype, optim, train_transform, valid_transform, resized,
